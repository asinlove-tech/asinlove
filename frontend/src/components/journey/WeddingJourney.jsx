import { GopuramTop } from "./GopuramTop";
...
export const WeddingJourney = () => (
    <div className="relative">
        <div
            ...
            style={{
                backgroundImage: "url(/asinlove/images/pattern-tile.webp)",
                backgroundSize: "1300px",
                backgroundRepeat: "repeat",
            }}
        />
        <main className="relative z-10">
            {/* Gopuram top: names overlayed on the temple tower */}
            <GopuramTop />
            {/* Carpet area: Ganesha + blessing text overlayed */}
